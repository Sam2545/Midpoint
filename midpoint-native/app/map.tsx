...
import { ArrowLeft, MapPin, Star, Users, Share2, Navigation } from 'lucide-react-native';
      ...
      <CardContent className="p-4">
        ...
        <View className="flex-row items-center gap-4 mb-2">
          <View className="flex-row items-center gap-1">
            ...
            <Text className="text-sm text-muted-foreground">{place.distance}</Text>
          </View>
          <View className="flex-row items-center gap-1">
            <Users size={16} color="#64748b" />
            <Text className="text-sm text-muted-foreground">{place.usersGoing} going</Text>
          </View>
        </View>
              ...
              >
                ...
                <View className="flex-row items-center justify-between">
                  <View className="flex-row items-center gap-3">
                    ...
                    <View>
                      <Text className="text-2xl font-semibold text-white">Midpoint Found</Text>
                      <Text className="text-white/80 text-sm">Central location results</Text>
                    </View>
                  </View>
                </View>
              </LinearGradient>
              ...
              <View className="p-6">
                ...
                <View className="flex-row items-center justify-between mb-4">
                  <Text className="text-lg font-semibold">
                    Nearby {activity === 'restaurants' ? 'Restaurants' : activity === 'shopping' ? 'Shopping' : 'Cafes'}
                  </Text>
                  <Badge className="bg-secondary text-secondary-foreground">
                ...
                >
                  ...
                  <Text className="ml-2 text-primary-foreground">Share Midpoint with Group</Text>
                </Button>
              </View>
            </View>
          </View>
